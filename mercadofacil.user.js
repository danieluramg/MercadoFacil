...
$(document).ready(function(){
    ...
    var mfacil_button = '<li role="presentation" id="mfacil_button" class="ch-bellows"><span style="cursor: pointer;" id="mfacil_config" class="ch-bellows-trigger">MercadoFacil</span></li>';
