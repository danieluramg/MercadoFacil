...
$(document).ready(function(){
    ...
    function verifica_perguntas(){
        ...
        if (contador_perguntas >= 1){
            GM_log("Tem perguntas para responder!");
    ...
    if ( location.host == 'questions.mercadolivre.com.br' ) {
        GM_log("Funções da pagina de perguntas"); //debug
        ...
        if (mf_cumprimento == 'checked'){
            setTimeout(function(){ //da um delay pra carregar as perguntas
                GM_log("entrou na função do delay"); //debug
                $('textarea').click(function(e){
                    GM_log(e.target + " clicado"); //debug
